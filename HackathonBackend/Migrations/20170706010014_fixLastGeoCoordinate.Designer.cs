...
namespace HackathonBackend.Migrations
{
    ...
    [Migration("20170706010014_fixLastGeoCoordinate")]
    partial class fixLastGeoCoordinate
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("HackathonBackend.Models.User", b =>
                {
                    ...
                    b.Property<int>("LastGeoCoordinateID");
                    ...
                    b.HasIndex("LastGeoCoordinateID");
            ...
            modelBuilder.Entity("HackathonBackend.Models.User", b =>
                {
                    b.HasOne("HackathonBackend.Models.GeoCoordinate", "LastGeoCoordinate")
                        .WithMany("Users")
                        .HasForeignKey("LastGeoCoordinateID");
                });
        }
    }
}
